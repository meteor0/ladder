package com.liuxin.ladder.algorithms.pdf.demo1;
...
public class LinkedCollection implements Collection {
    ...
    public int size() {
        ...
        for ( Entry courent = head;courent!= null;courent = courent.next){
            count ++;
        }
        return count;
    }
    ...
    public static void main(String[] args) {
        ...
        linkedCollection.add("11");
        System.out.println(linkedCollection);
        linkedCollection.add("22");
        System.out.println(linkedCollection);
        linkedCollection.add("33");
        System.out.println(linkedCollection);
        linkedCollection.add("44");
